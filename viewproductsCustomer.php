...
<div class='container'>
	...
	<fieldset><legend><b>View Products Categories</b></legend>
		...
		<?php 
			if(isset($_GET['submit'])){
				...
				$result=mysqli_query($conn,$sql);
				echo "<fieldset><legend><b>View Products</b></legend>
					<table><tr><th>Product ID</th><th>Product Name</th><th>Price(kg)</th><th>Stock Left(kg)</th></tr>";
				while($row=mysqli_fetch_assoc($result)){
